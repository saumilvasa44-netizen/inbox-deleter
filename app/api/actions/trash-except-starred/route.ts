...
// Moves one page (up to 500) of everything not already in Trash AND not
// starred into Trash. Recoverable for ~30 days. The client calls this
// repeatedly until processed comes back 0.
